...
/*	       		if($filepath == "js1.txt")
				...
				{
					if($filepath == "js.txt")
						$oFile = fopen("$sDocRoot/scripts/deskera.js", 'w');
					else
						$oFile = fopen("$sDocRoot/scripts/deskera_ex.js", 'w');
				}*/
					$oFile = fopen("$sDocRoot/scripts/HQLPayroll.js", 'w');
